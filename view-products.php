                                    ...
                                    <tr>
                                        ...
                                        <td class="text-nowrap">
                                            <a href="../stocks/stocks.php?id=<?= $arr['id'] ?>"
                                                class="btn btn-sm btn-outline-primary me-1 stock-in-out"
                                                data-id="<?= $arr['id'] ?>">Stock In/Out</a>
                                            <a href="" class="btn btn-sm btn-outline-success me-1 edit-product"
                                                data-id="<?= $arr['id'] ?>">Edit</a>
